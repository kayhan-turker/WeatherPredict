...
# ====================================
# 4. Function, Class Initialization
# ====================================
def weights_init(m):
...
dst_folder = GENERATION_OUTPUT_PATH + "training/" + ts
...
for epoch in range(epochs):
    ...
    fake_image_pil.save(f"{dst_folder}/E{(epoch + 1):03}_{output_str}.png")  # Save fake image
