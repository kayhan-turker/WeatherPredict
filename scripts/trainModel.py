...
for epoch in range(epochs):
    ...
    print("")
    print(f"G FiLM Gamma Weight Std: γ1 = {float(film1_std_params[0]):.3f}, γ2 = {float(film2_std_params[0]):.3f}, γ3 = {float(film3_std_params[0]):.3f}")
    print(f"G FiLM Gamma Biases Std: γ1 = {float(film1_std_params[1]):.3f}, γ2 = {float(film2_std_params[1]):.3f}, γ3 = {float(film3_std_params[1]):.3f}")
    print(f"G FiLM Beta Weights Std: β1 = {float(film1_std_params[2]):.3f}, β2 = {float(film2_std_params[2]):.3f}, β3 = {float(film3_std_params[2]):.3f}")
    print(f"G FiLM Beta Biases Std: β1 = {float(film1_std_params[3]):.3f}, β2 = {float(film2_std_params[3]):.3f}, β3 = {float(film3_std_params[3]):.3f}")
    print("")
